...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Repthon"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Repthon_support"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@ZQ_LO"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@XXFIR"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@eighthon"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Repthonn"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Repthon_vars"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Repthon_test"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@Repthon_cklaish"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس ريبـــثون يعمل بنجاح 😍**')
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس ريبـــثون
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('Repthon'))
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                ...
                await sython1.send_message(event.chat_id, f"تم الانتهاء من التجميع | Rep")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | 𝐑𝐞𝐩𝐭𝐡𝐨𝐧")
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('ZQ_LO'))
...
async def _(event):
    ...
    await sython1.send_message(event.chat_id, "**تم الانتهاء من التجميع |Rep**")
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس ريبـــثون ☺**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinw = await sython1(JoinChannelRequest('ZQ_LO'))



        joine = await sython1(JoinChannelRequest('Repthon_vars'))



        joinr = await sython1(JoinChannelRequest('Repthon_help'))



        joint = await sython1(JoinChannelRequest('Repthonn'))



        joiny = await sython1(JoinChannelRequest('Repthon_cklaish'))



        joini = await sython1(JoinChannelRequest('Repthon_up'))



        joino = await sython1(JoinChannelRequest('xxfir'))



        joinp = await sython1(JoinChannelRequest('ICTHON'))



        joina = await sython1(JoinChannelRequest('eigthon'))
...
#code skip accumulate points by t.me.E_7_V thank you my bro
